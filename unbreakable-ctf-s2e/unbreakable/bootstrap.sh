...
function execute_target {
    ...
    # unbreakable is dynamically linked, so s2e.so has been preloaded to
...
execute "${TARGET_PATH}" CTF{xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
